...
export class MailsService {
	allMails: Mail[] = [
		...
		new Mail(
			...
			'<p>The arrangements for the Harvest after the black moon are almost done.</p><p>The bullshit on the TV and internet can just help our goals. Let those lower beings talk about chips, graphene, 5G or whichever shit they want on Covid and the vaccines. It’s just the perfect smokescreen for us to silently harvest the return of the King in Yellow to carcosa.</p><p>Concerning the uncontrolled sources you mention, we believe any possible disturbance was eliminated. The were only 3 sources for the name of Khofith:</p><ul><li>The letter from L. Caelius Rufus, eliminated during &apos;68 disturbances</li><li>Codex Milesius, burnt during the coups in Turkey in the &apos;80s</li><li>The paper from Armitage: Only <a href="https://pharmevilstatic.osumi.es/paper.html">one copy</a> remains in Section 9. Just to remind us of Dunwich.</li></ul><p>Be assured, blood will drip and Khofith will awake.</p><div class="signature">iä iä Khofith Nyantin!</div>'
		),
		new Mail(
			7,
			'sent',
